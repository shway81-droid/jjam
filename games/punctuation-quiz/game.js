/* games/punctuation-quiz/game.js */
...
const QUESTION_POOL = [
  { q: "설명하는 문장 끝에 찍는 부호는?", a: "마침표", o: ["물음표", "느낌표", "쉼표"] },
  { q: "묻는 문장 끝에 쓰는 부호는?", a: "물음표", o: ["마침표", "느낌표", "쉼표"] },
  { q: "놀라거나 강한 느낌을 나타내는 부호는?", a: "느낌표", o: ["마침표", "물음표", "쉼표"] },
  { q: "문장에서 잠깐 쉬거나 낱말을 나열할 때 쓰는 부호는?", a: "쉼표", o: ["마침표", "물음표", "느낌표"] },
  { q: "남이 한 말을 그대로 적을 때 앞뒤로 쓰는 부호는?", a: "큰따옴표", o: ["작은따옴표", "쉼표", "마침표"] },
  { q: "\"안녕?\"에서 물음표는 어떤 문장에 쓸까요?", a: "묻는 문장", o: ["설명하는 문장", "감탄하는 문장", "명령하는 문장"] },
  { q: "\"정말 멋지다!\"의 끝에 쓴 부호 이름은?", a: "느낌표", o: ["물음표", "마침표", "쉼표"] },
  { q: "\"나는 밥을 먹었다.\"의 끝에 쓴 부호 이름은?", a: "마침표", o: ["느낌표", "물음표", "큰따옴표"] },
  { q: "속으로 생각한 말을 적을 때 흔히 쓰는 부호는?", a: "작은따옴표", o: ["큰따옴표", "느낌표", "물음표"] },
  { q: "\"사과, 배, 감\"처럼 낱말을 늘어놓을 때 쓰는 부호는?", a: "쉼표", o: ["마침표", "물음표", "느낌표"] },
  { q: "여러 부호 중 문장이 끝났음을 알리는 부호는?", a: "마침표", o: ["쉼표", "따옴표", "물음표"] },
  { q: "놀랐을 때 \"앗!\"에 쓰는 부호는?", a: "느낌표", o: ["마침표", "물음표", "쉼표"] },
]
