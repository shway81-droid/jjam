...
const QUESTION_POOL = [
  { q: "<span class='q-emoji'>🚗</span><br>이 탈것의 이름은?", a: "자동차", o: ["경주용차", "여객선", "케이블카"] },
  { q: "<span class='q-emoji'>🚕</span><br>이 탈것의 이름은?", a: "택시", o: ["돛단배", "오토바이", "로켓"] },
  { q: "<span class='q-emoji'>🚌</span><br>이 탈것의 이름은?", a: "버스", o: ["소방차", "대형트럭", "택시"] },
  { q: "<span class='q-emoji'>🚓</span><br>이 탈것의 이름은?", a: "경찰차", o: ["킥보드", "배", "카누"] },
  { q: "<span class='q-emoji'>🚑</span><br>이 탈것의 이름은?", a: "구급차", o: ["트럭", "소방차", "카누"] },
  { q: "<span class='q-emoji'>🚒</span><br>이 탈것의 이름은?", a: "소방차", o: ["버스", "경찰차", "킥보드"] },
  { q: "<span class='q-emoji'>🚚</span><br>이 탈것의 이름은?", a: "트럭", o: ["기차", "전차", "지하철"] },
  { q: "<span class='q-emoji'>🚜</span><br>이 탈것의 이름은?", a: "트랙터", o: ["배", "대형트럭", "지프차"] },
  { q: "<span class='q-emoji'>🏍️</span><br>이 탈것의 이름은?", a: "오토바이", o: ["기차", "소방차", "자동차"] },
  { q: "<span class='q-emoji'>🚲</span><br>이 탈것의 이름은?", a: "자전거", o: ["돛단배", "자동차", "여객선"] },
  { q: "<span class='q-emoji'>🛴</span><br>이 탈것의 이름은?", a: "킥보드", o: ["스쿠터", "트랙터", "모터보트"] },
  { q: "<span class='q-emoji'>🚂</span><br>이 탈것의 이름은?", a: "기차", o: ["자동차", "지하철", "곤돌라"] },
  { q: "<span class='q-emoji'>🚇</span><br>이 탈것의 이름은?", a: "지하철", o: ["고속열차", "승합차", "돛단배"] },
  { q: "<span class='q-emoji'>🚊</span><br>이 탈것의 이름은?", a: "전차", o: ["스쿠터", "승합차", "비행기"] },
  { q: "<span class='q-emoji'>🚄</span><br>이 탈것의 이름은?", a: "고속열차", o: ["모터보트", "카누", "지하철"] },
  { q: "<span class='q-emoji'>✈️</span><br>이 탈것의 이름은?", a: "비행기", o: ["버스", "카누", "전차"] },
  ...
  { q: "<span class='q-emoji'>🚐</span><br>이 탈것의 이름은?", a: "승합차", o: ["구급차", "모터보트", "여객선"] },
  { q: "<span class='q-emoji'>🛵</span><br>이 탈것의 이름은?", a: "스쿠터", o: ["케이블카", "배", "카누"] },
  { q: "<span class='q-emoji'>🚙</span><br>이 탈것의 이름은?", a: "지프차", o: ["경주용차", "트럭", "트랙터"] },
