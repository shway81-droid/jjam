...
const QUESTION_POOL = [
  { q: "<span class='q-emoji'>🍕</span><br>이 음식의 이름은?", a: "피자", o: ["치즈", "크루아상", "팬케이크"] },
  { q: "<span class='q-emoji'>🍔</span><br>이 음식의 이름은?", a: "햄버거", o: ["프레첼", "타코", "빠에야"] },
  { q: "<span class='q-emoji'>🍟</span><br>이 음식의 이름은?", a: "감자튀김", o: ["팝콘", "달걀프라이", "햄버거"] },
  { q: "<span class='q-emoji'>🌭</span><br>이 음식의 이름은?", a: "핫도그", o: ["스파게티", "바게트", "도시락"] },
  { q: "<span class='q-emoji'>🍿</span><br>이 음식의 이름은?", a: "팝콘", o: ["샌드위치", "핫도그", "도시락"] },
  { q: "<span class='q-emoji'>🥪</span><br>이 음식의 이름은?", a: "샌드위치", o: ["햄버거", "핫도그", "스파게티"] },
  { q: "<span class='q-emoji'>🌮</span><br>이 음식의 이름은?", a: "타코", o: ["라면", "새우튀김", "초밥"] },
  { q: "<span class='q-emoji'>🌯</span><br>이 음식의 이름은?", a: "부리토", o: ["바게트", "샐러드", "와플"] },
  { q: "<span class='q-emoji'>🍝</span><br>이 음식의 이름은?", a: "스파게티", o: ["라면", "팝콘", "피자"] },
  { q: "<span class='q-emoji'>🍜</span><br>이 음식의 이름은?", a: "라면", o: ["프레첼", "피자", "크루아상"] },
  { q: "<span class='q-emoji'>🍣</span><br>이 음식의 이름은?", a: "초밥", o: ["와플", "샌드위치", "샐러드"] },
  { q: "<span class='q-emoji'>🍤</span><br>이 음식의 이름은?", a: "새우튀김", o: ["피자", "라면", "달걀프라이"] },
  { q: "<span class='q-emoji'>🍛</span><br>이 음식의 이름은?", a: "카레", o: ["새우튀김", "팬케이크", "프레첼"] },
  { q: "<span class='q-emoji'>🥘</span><br>이 음식의 이름은?", a: "빠에야", o: ["와플", "팬케이크", "새우튀김"] },
  { q: "<span class='q-emoji'>🥨</span><br>이 음식의 이름은?", a: "프레첼", o: ["샐러드", "주먹밥", "라면"] },
  { q: "<span class='q-emoji'>🥐</span><br>이 음식의 이름은?", a: "크루아상", o: ["햄버거", "주먹밥", "초밥"] },
  { q: "<span class='q-emoji'>🥖</span><br>이 음식의 이름은?", a: "바게트", o: ["라면", "크루아상", "프레첼"] },
  { q: "<span class='q-emoji'>🧀</span><br>이 음식의 이름은?", a: "치즈", o: ["바게트", "와플", "팝콘"] },
  { q: "<span class='q-emoji'>🥞</span><br>이 음식의 이름은?", a: "팬케이크", o: ["달걀프라이", "라면", "초밥"] },
  { q: "<span class='q-emoji'>🧇</span><br>이 음식의 이름은?", a: "와플", o: ["바게트", "샌드위치", "크루아상"] },
  { q: "<span class='q-emoji'>🍙</span><br>이 음식의 이름은?", a: "주먹밥", o: ["새우튀김", "와플", "달걀프라이"] },
  { q: "<span class='q-emoji'>🍱</span><br>이 음식의 이름은?", a: "도시락", o: ["핫도그", "새우튀김", "와플"] },
  { q: "<span class='q-emoji'>🥗</span><br>이 음식의 이름은?", a: "샐러드", o: ["팝콘", "타코", "빠에야"] },
  { q: "<span class='q-emoji'>🍳</span><br>이 음식의 이름은?", a: "달걀프라이", o: ["핫도그", "도시락", "크루아상"] },
];
