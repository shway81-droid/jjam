...
const QUESTION_POOL = [
  { q: "십이지에서 가장 첫 번째 동물은?", a: "쥐", o: ["소", "호랑이", "돼지"] },
  { q: "십이지에서 쥐 다음에 오는 동물은?", a: "소", o: ["호랑이", "토끼", "용"] },
  { q: "십이지에서 가장 마지막 동물은?", a: "돼지", o: ["개", "닭", "쥐"] },
  { q: "십이지 동물 중 상상 속의 동물은?", a: "용", o: ["말", "양", "닭"] },
  { q: "십이지에서 호랑이 다음에 오는 동물은?", a: "토끼", o: ["용", "뱀", "말"] },
  { q: "십이지에서 말 다음에 오는 동물은?", a: "양", o: ["원숭이", "닭", "개"] },
  { q: "나무를 잘 타고 사람을 닮은, 닭 앞의 십이지 동물은?", a: "원숭이", o: ["개", "돼지", "양"] },
  { q: "십이지에서 소 다음, 토끼 앞의 동물은?", a: "호랑이", o: ["용", "뱀", "쥐"] },
  { q: "십이지에서 용 다음에 오는 동물은?", a: "뱀", o: ["말", "양", "쥐"] },
  { q: "십이지에서 원숭이 다음에 오는 동물은?", a: "닭", o: ["개", "돼지", "소"] },
  { q: "십이지에서 닭 다음, 돼지 앞의 동물은?", a: "개", o: ["원숭이", "말", "쥐"] },
  { q: "십이지에서 뱀 다음에 오는 동물은?", a: "말", o: ["양", "원숭이", "닭"] },
]
