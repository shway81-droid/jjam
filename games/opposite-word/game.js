/* games/opposite-word/game.js — 패턴 A (4지선다 동시반응) — 반대말 맞히기 */
'use strict';
...
// ── Word Data: 30+ opposite-word pairs ───────────────────────
const ALL_WORDS = [
  { word: '크다',   opposite: '작다' },
  { word: '높다',   opposite: '낮다' },
  { word: '길다',   opposite: '짧다' },
  { word: '많다',   opposite: '적다' },
  { word: '빠르다', opposite: '느리다' },
  { word: '뜨겁다', opposite: '차갑다' },
  { word: '밝다',   opposite: '어둡다' },
  { word: '무겁다', opposite: '가볍다' },
  { word: '두껍다', opposite: '얇다' },
  { word: '넓다',   opposite: '좁다' },
  { word: '깊다',   opposite: '얕다' },
  { word: '강하다', opposite: '약하다' },
  { word: '딱딱하다', opposite: '말랑하다' },
  { word: '기쁘다', opposite: '슬프다' },
  { word: '쉽다',   opposite: '어렵다' },
  { word: '깨끗하다', opposite: '더럽다' },
  { word: '시작',   opposite: '끝' },
  { word: '아침',   opposite: '저녁' },
  { word: '낮',     opposite: '밤' },
  { word: '봄',     opposite: '가을' },
  ...
  { word: '위',     opposite: '아래' },
  { word: '앞',     opposite: '뒤' },
  { word: '왼쪽',   opposite: '오른쪽' },
  { word: '안',     opposite: '밖' },
  { word: '들어가다', opposite: '나가다' },
  { word: '올라가다', opposite: '내려가다' },
  { word: '열다',   opposite: '닫다' },
  { word: '주다',   opposite: '받다' },
  { word: '웃다',   opposite: '울다' },
  { word: '서다',   opposite: '앉다' },
...
// 4지선다: 정답(반대말) + 다른 3개 단어 (보기 후보는 다른 쌍의 word 또는 opposite, 문제 단어와 정답은 제외)
function makeChoices(currentPair) {
  const correctName = currentPair.opposite;
  const usedSet = new Set([currentPair.word, currentPair.opposite]);

  const pool = [];
  ALL_WORDS.forEach(p => {
    if (p === currentPair) return;
    if (!usedSet.has(p.word)) { pool.push(p.word); usedSet.add(p.word); }
    if (!usedSet.has(p.opposite)) { pool.push(p.opposite); usedSet.add(p.opposite); }
  });
