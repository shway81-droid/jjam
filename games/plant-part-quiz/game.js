...
const QUESTION_POOL = [
  { q: "땅속으로 뻗어 물을 빨아들이는 부분은?", a: "뿌리", o: ["잎", "꽃", "열매"] },
  { q: "식물을 곧게 세우고 물길이 지나가는 부분은?", a: "줄기", o: ["뿌리", "꽃", "씨앗"] },
  { q: "햇빛을 받아 양분을 만드는 넓적한 부분은?", a: "잎", o: ["뿌리", "줄기", "열매"] },
  { q: "예쁘게 피어 벌과 나비를 부르는 부분은?", a: "꽃", o: ["뿌리", "잎", "줄기"] },
  { q: "꽃이 진 자리에 열리며 씨를 품는 부분은?", a: "열매", o: ["뿌리", "잎", "줄기"] },
  { q: "새로운 식물로 자라날 작은 알갱이는?", a: "씨앗", o: ["잎", "꽃", "줄기"] },
  { q: "잎이 햇빛으로 양분을 만드는 일을 무엇이라 할까요?", a: "광합성", o: ["증발", "단풍", "낙엽"] },
  { q: "가을에 잎이 붉고 노랗게 물드는 것은?", a: "단풍", o: ["새싹", "꽃봉오리", "열매"] },
  { q: "봄에 새로 돋아나는 어린잎은?", a: "새싹", o: ["낙엽", "열매", "뿌리"] },
  { q: "꽃가루가 암술에 붙는 것을 무엇이라 할까요?", a: "꽃가루받이", o: ["광합성", "단풍", "증발"] },
  { q: "민들레 씨앗이 바람에 날아가게 돕는 하얀 것은?", a: "홀씨", o: ["꽃잎", "뿌리", "열매"] },
  { q: "식물이 자라는 데 꼭 필요하지 않은 것은?", a: "어둠", o: ["햇빛", "물", "공기"] },
  { q: "꽃에서 씨를 만드는 데 필요한 노란 가루는?", a: "꽃가루", o: ["꿀", "이슬", "단풍"] },
  { q: "식물이 물을 빨아들이는 곳은?", a: "뿌리", o: ["꽃", "열매", "잎"] },
]
