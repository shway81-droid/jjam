/* games/fruit-code/game.js */

'use strict';

// ── Constants ────────────────────────────────────────────────
const TOTAL_QUESTIONS  = 10;
const TIMEOUT_MS       = 8000;   // 8 seconds per question (substitution + calc)
...
// ── Question pool ────────────────────────────────────────────
// 대입 추론: 과일마다 숨은 숫자를 힌트로 주고, 그 값을 식에 넣어 계산한다.
// 값이 모두 주어지므로 답은 하나로 확정된다. 보기는 정답 근처의 서로 다른 정수.
// `q`는 HTML(힌트 <br> + 식 <b>)로 렌더한다.
const QUESTION_POOL = [
  { q: '🍎=2, 🍌=3<br><b>🍎 + 🍌 = ?</b>', a: '5', o: ['4', '6', '7'] },
  { q: '🍓=4, 🍇=2<br><b>🍓 + 🍇 = ?</b>', a: '6', o: ['5', '7', '8'] },
  { q: '🍎=5, 🍌=2<br><b>🍎 − 🍌 = ?</b>', a: '3', o: ['7', '2', '4'] },
  { q: '🍊=3, 🍎=4<br><b>🍊 + 🍎 + 🍊 = ?</b>', a: '10', o: ['9', '11', '7'] },
  { q: '🍌=6, 🍓=2<br><b>🍌 − 🍓 = ?</b>', a: '4', o: ['8', '3', '5'] },
  { q: '🍎=2<br><b>🍎 + 🍎 + 🍎 = ?</b>', a: '6', o: ['5', '4', '8'] },
  { q: '🍇=3, 🍊=5<br><b>🍇 + 🍊 = ?</b>', a: '8', o: ['7', '9', '6'] },
  { q: '🍓=7, 🍎=3<br><b>🍓 − 🍎 = ?</b>', a: '4', o: ['10', '5', '3'] },
  { q: '🍌=4, 🍎=4<br><b>🍌 + 🍎 = ?</b>', a: '8', o: ['4', '7', '9'] },
  { q: '🍊=6, 🍇=1<br><b>🍊 − 🍇 = ?</b>', a: '5', o: ['7', '6', '4'] },
  { q: '🍎=3, 🍌=2, 🍓=5<br><b>🍎 + 🍌 + 🍓 = ?</b>', a: '10', o: ['9', '11', '8'] },
  { q: '🍇=8, 🍊=3<br><b>🍇 − 🍊 = ?</b>', a: '5', o: ['11', '6', '4'] },
  { q: '🍎=2, 🍌=5<br><b>🍎 + 🍌 + 🍌 = ?</b>', a: '12', o: ['9', '10', '7'] },
  { q: '🍓=6<br><b>🍓 + 🍓 = ?</b>', a: '12', o: ['6', '10', '14'] },
  { q: '🍊=4, 🍎=7<br><b>🍊 + 🍎 = ?</b>', a: '11', o: ['10', '12', '3'] },
  { q: '🍌=9, 🍇=4<br><b>🍌 − 🍇 = ?</b>', a: '5', o: ['13', '6', '3'] },
  { q: '🍎=1, 🍌=2, 🍊=3<br><b>🍎 + 🍌 + 🍊 = ?</b>', a: '6', o: ['5', '7', '4'] },
  { q: '🍓=5, 🍇=5<br><b>🍓 + 🍇 = ?</b>', a: '10', o: ['5', '15', '9'] },
  { q: '🍊=7, 🍎=2<br><b>🍊 − 🍎 = ?</b>', a: '5', o: ['9', '6', '4'] },
  { q: '🍌=3<br><b>🍌 + 🍌 + 🍌 + 🍌 = ?</b>', a: '12', o: ['9', '15', '6'] },
  { q: '🍎=6, 🍓=4<br><b>🍎 + 🍓 = ?</b>', a: '10', o: ['2', '9', '11'] },
  { q: '🍇=10, 🍊=6<br><b>🍇 − 🍊 = ?</b>', a: '4', o: ['16', '5', '3'] },
  { q: '🍎=4, 🍌=3<br><b>🍎 + 🍌 + 🍎 = ?</b>', a: '11', o: ['10', '12', '7'] },
  { q: '🍓=8, 🍇=3<br><b>🍓 − 🍇 = ?</b>', a: '5', o: ['11', '6', '4'] },
  { q: '🍊=2, 🍎=2, 🍌=2<br><b>🍊 + 🍎 + 🍌 = ?</b>', a: '6', o: ['4', '8', '5'] },
  { q: '🍎=5, 🍓=1<br><b>🍎 − 🍓 = ?</b>', a: '4', o: ['6', '3', '5'] },
  { q: '🍌=7, 🍇=2<br><b>🍌 + 🍇 = ?</b>', a: '9', o: ['5', '10', '8'] },
  { q: '🍊=9, 🍎=4<br><b>🍊 − 🍎 = ?</b>', a: '5', o: ['13', '6', '3'] },
  { q: '🍓=3, 🍇=6<br><b>🍓 + 🍇 = ?</b>', a: '9', o: ['3', '8', '10'] },
  { q: '🍎=8, 🍌=8<br><b>🍎 + 🍌 = ?</b>', a: '16', o: ['8', '15', '17'] },
  { q: '🍇=5, 🍊=4, 🍎=1<br><b>🍇 + 🍊 − 🍎 = ?</b>', a: '8', o: ['10', '7', '9'] },
  { q: '🍌=7, 🍓=2, 🍇=3<br><b>🍌 − 🍓 + 🍇 = ?</b>', a: '8', o: ['6', '12', '9'] },
];
