...
const QUESTION_POOL = [
  { q: "해가 떠오르는 쪽은?", a: "동쪽", o: ["서쪽", "남쪽", "북쪽"] },
  { q: "해가 지는 쪽은?", a: "서쪽", o: ["동쪽", "남쪽", "북쪽"] },
  { q: "나침반의 빨간 바늘이 가리키는 쪽은?", a: "북쪽", o: ["남쪽", "동쪽", "서쪽"] },
  { q: "북쪽을 바라볼 때 등 뒤쪽은?", a: "남쪽", o: ["동쪽", "서쪽", "북쪽"] },
  { q: "하늘은 어느 쪽에 있나요?", a: "위쪽", o: ["아래쪽", "왼쪽", "오른쪽"] },
  { q: "땅은 어느 쪽에 있나요?", a: "아래쪽", o: ["위쪽", "앞쪽", "뒤쪽"] },
  { q: "오른손이 있는 쪽은?", a: "오른쪽", o: ["왼쪽", "위쪽", "아래쪽"] },
  { q: "왼손이 있는 쪽은?", a: "왼쪽", o: ["오른쪽", "앞쪽", "뒤쪽"] },
  { q: "내가 바라보고 있는 쪽은?", a: "앞쪽", o: ["뒤쪽", "위쪽", "아래쪽"] },
  { q: "내 등이 향하는 쪽은?", a: "뒤쪽", o: ["앞쪽", "왼쪽", "오른쪽"] },
  { q: "북쪽을 볼 때 오른손 쪽은?", a: "동쪽", o: ["서쪽", "남쪽", "북쪽"] },
  { q: "북쪽을 볼 때 왼손 쪽은?", a: "서쪽", o: ["동쪽", "남쪽", "북쪽"] },
  { q: "한가운데를 무엇이라고 할까요?", a: "가운데", o: ["가장자리", "모서리", "꼭대기"] },
  { q: "지도에서 위쪽은 보통 어느 방향일까요?", a: "북쪽", o: ["남쪽", "동쪽", "서쪽"] },
]
